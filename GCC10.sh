...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	echo " "
		...
		git clone --depth=1 https://github.com/vcyzteen/aarch64-maestro-linux-android -b 05022020 $KERNEL_DIR/gcc64
		git clone --depth=1 https://github.com/vcyzteen/arm-maestro-linux-gnueabi -b 05022020 $KERNEL_DIR/gcc32
